...
- Be guided through the implementation of the latest RAP features:
	- [Collaborative Draft](/../../wiki/Collaborative-Draft) (2508) - Development Effort: S
	- [Draft Scope](/../../wiki/Draft-Scope) (2508) - Development Effort: M
	 - [Recommendations](/../../wiki/Recommendations) (2602) - Development Effort: L
	- [Editable Treeview](/../../wiki/Editable-Treeview) (2502) - Development Effort: L
	- [Analytical Table (Read-Only)](/../../wiki/Analytical-Table) (2511) - Development Effort: M
...
## Technical Setup
- A dedicated ABAP System in an SAP BTP ABAP environment (2602) is prepared for this event. System details will be shared by the instructors.
...
## License
Copyright (c) 2026 SAP SE or an SAP affiliate company and abap-platform-codejam-latest-features-2602 contributors. All rights reserved. This project is licensed under the Apache Software License, version 2.0 except as noted otherwise in the [LICENSE](LICENSES/Apache-2.0.txt) file; you may not use any file of this project except in compliance with the License.
